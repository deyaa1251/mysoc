...
VL_ATTR_COLD void Vtop_verilator_ibex_pkg___ctor_var_reset(Vtop_verilator_ibex_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+                      Vtop_verilator_ibex_pkg___ctor_var_reset\n"); );
