...
unsigned int Vtop_verilator::mhpmcounter_num() {
    ...
    Vtop_verilator__Vcb_mhpmcounter_num_t __Vcb = (Vtop_verilator__Vcb_mhpmcounter_num_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
unsigned long long Vtop_verilator::mhpmcounter_get(int index) {
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    Vtop_verilator__Vcb_mhpmcounter_get_t __Vcb = (Vtop_verilator__Vcb_mhpmcounter_get_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
...
int Vtop_verilator::simutil_get_scramble_key(svBitVecVal* val) {
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    Vtop_verilator__Vcb_simutil_get_scramble_key_t __Vcb = (Vtop_verilator__Vcb_simutil_get_scramble_key_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
int Vtop_verilator::simutil_get_scramble_nonce(svBitVecVal* nonce) {
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    Vtop_verilator__Vcb_simutil_get_scramble_nonce_t __Vcb = (Vtop_verilator__Vcb_simutil_get_scramble_nonce_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
void Vtop_verilator::simutil_memload(const char* file) {
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    Vtop_verilator__Vcb_simutil_memload_t __Vcb = (Vtop_verilator__Vcb_simutil_memload_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
...
int Vtop_verilator::simutil_set_mem(int index, const svBitVecVal* val) {
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    Vtop_verilator__Vcb_simutil_set_mem_t __Vcb = (Vtop_verilator__Vcb_simutil_set_mem_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
...
int Vtop_verilator::simutil_get_mem(int index, svBitVecVal* val) {
    ...
    const VerilatedScope* const __Vscopep = Verilated::dpiScope();
    Vtop_verilator__Vcb_simutil_get_mem_t __Vcb = (Vtop_verilator__Vcb_simutil_get_mem_t)(VerilatedScope::exportFind(__Vscopep, __Vfuncnum));
    index__Vcvt = index;
