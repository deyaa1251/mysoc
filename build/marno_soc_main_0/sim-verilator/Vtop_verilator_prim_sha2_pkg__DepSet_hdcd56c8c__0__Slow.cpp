...
VL_ATTR_COLD void Vtop_verilator_prim_sha2_pkg___ctor_var_reset(Vtop_verilator_prim_sha2_pkg* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtop_verilator_prim_sha2_pkg___ctor_var_reset\n"); );
